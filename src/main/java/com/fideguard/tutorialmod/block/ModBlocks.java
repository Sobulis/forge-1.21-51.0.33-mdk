...
public class ModBlocks {
    ...
    public static final RegistryObject<ButtonBlock> ALEXANDRITE_BUTTON = registerBlock("alexandrite_button",
            () -> new ButtonBlock(BlockSetType.IRON, 3, BlockBehaviour.Properties.of().strength(3f) //The number after BlockSetType stands for how many ticks, the button stays pressed down for
                    .requiresCorrectToolForDrops().noCollission())); //Buttons don't have collision
