...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(RecipeOutput pRecipeOutput) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.ALEXANDRITE_AXE.get())
                ...
                .define('X', Items.STICK)
                .unlockedBy(getHasName(ModItems.ALEXANDRITE.get()), has(ModItems.ALEXANDRITE.get()))
                .save(pRecipeOutput, TutorialMod.MOD_ID+"alexandrite_axe_from_left");
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.ALEXANDRITE_AXE.get())
                ...
                .define('X', Items.STICK)
                .unlockedBy(getHasName(ModItems.ALEXANDRITE.get()), has(ModItems.ALEXANDRITE.get()))
                .save(pRecipeOutput, TutorialMod.MOD_ID+"alexandrite_axe_from_right");
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.KAUPEN_SMITHING_TEMPLATE.get(), 2)
                ...
                .define('S', ModItems.KAUPEN_SMITHING_TEMPLATE.get())
                .define('B', ModBlocks.ALEXANDRITE_BLOCK.get())
                .unlockedBy("has_template", has(ModItems.KAUPEN_SMITHING_TEMPLATE.get()))
                .save(pRecipeOutput);

        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.FIDEGUARD_BOW.get())
                .pattern(" AS")
                .pattern("A S")
                .pattern(" AS")
                .define('A', ModItems.ALEXANDRITE.get())
