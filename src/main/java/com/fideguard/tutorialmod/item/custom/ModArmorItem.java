...
import com.fideguard.tutorialmod.item.ModArmorMaterials;
...
//Only work with the custom materials, not the vanilla armour materials
            ...
            (new ImmutableMap.Builder<Holder<ArmorMaterial>, List<MobEffectInstance>>())
                    .put(ModArmorMaterials.ALEXANDRITE_ARMOR_MATERIAL,
                            List.of(new MobEffectInstance(MobEffects.JUMP, 200, 1, false, false),
                                    ...
                                    new MobEffectInstance(MobEffects.SLOW_FALLING, 200, 1, false, false))) //The last bits is about particles and their visibility
                    //If there is another material, then just add another .put
                    .build();

    public ModArmorItem(Holder<ArmorMaterial> material, Type pType, Properties pProperties) {
